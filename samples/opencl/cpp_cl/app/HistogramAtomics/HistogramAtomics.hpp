...
class Histogram : public SDKSample
{
	...
	cl_uint     *input;
    cl_uint     *output;
	cl::Buffer inputBuffer;            /**< input buffer to device */
	cl::Buffer outputBuffer;           /**< output buffer from device */
	...
	cl::Kernel histogram;                      /**< Kernel object */
	cl::Kernel reduce;                      /**< Kernel object */
